...
def check_parameters():
    ...
    try:
        ...
        if settings.ANALYSE_COMBINATION not in [1, 2, 3, 4, 5]:
            print("Error 4: Entered analysis combination value is incorrect.")
            exit(4)

        # Checks if entered analysis value is correct
        if settings.ANALYSE_TYPE not in [1, 2, 3]:
            print("Error 5: Entered analysis type value is incorrect.")
            exit(5)
